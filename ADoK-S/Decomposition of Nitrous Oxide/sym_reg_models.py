...
initial_conditions = {
    ...
    "ic_6": np.array([0, 1.64123271, 1.0954021])
}
...
for i in range(num_exp):
    ...
    if i == 2:
        ...
        file_path = 'Decomposition of Nitrous Oxide/Experiment_Raw_Data_Decom.png'
...
#                 if j == 0:
#                     file_name = str(
#                         "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_NO_" \
#                         + str(i + 1) + ".csv"
#                         )
#                 if j == 1:
#                     file_name = str(
#                         "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_N_" \
#                         + str(i + 1) + ".csv"
#                         )
#                 if j == 2:
#                     file_name = str(
#                         "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_O_" \
#                         + str(i + 1) + ".csv"
#                         )
...
for i in range(num_exp):
    ...
    for j in range(num_species):
        if j == 0:
            file_name = str("Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_NO_" \
                + str(i + 1) + ".csv")
            name = "NO_"
        if j == 1:
            file_name = str("Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_N_" \
                + str(i + 1) + ".csv")
            name = "N_"
        if j == 2:
            file_name = str("Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_O_" \
                + str(i + 1) + ".csv")
            name = "O_"
...
for i in range(num_exp):
    ...
    if i == 2:
        file_path = 'Decomposition of Nitrous Oxide/Experiment_3_Conc_Model_Decom.png'
        plt.savefig(file_path, dpi = 600)
...
for i in range(num_exp):
    ...
    if i == 2:
        file_path = 'Decomposition of Nitrous Oxide/Experiment_3_Deri_Data_Decom.png'
        plt.savefig(file_path, dpi = 600)
...
#             if i == 0:
#                 file_name = str(
#                     "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_rate_NO.csv"
#                     )
#                 Y = SR_derivatives_NO
#                 num = 1000
#             if i == 1:
#                 file_name = str(
#                     "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_rate_N.csv"
#                     )
#                 Y = SR_derivatives_N
#                 num = 200
#             if i == 2:
#                 file_name = str(
#                     "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_rate_O.csv"
#                     )
#                 Y = SR_derivatives_O
#                 num = 200
...
for i in range(num_species):
    if i == 0:
        path = "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_rate_NO.csv"
        name_models = "NO_models"
        name_params = "NO_params"

    if i == 1:
        path = "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_rate_N.csv"
        name_models = "N_models"
        name_params = "N_params"
    
    if i == 2:
        path = "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_rate_O.csv"
...
for i in range(num_exp):
    ...
    if i == 2:
        file_path = 'Decomposition of Nitrous Oxide/Experiment_3_Final_Model_Decom.png'
        plt.savefig(file_path, dpi = 600)
