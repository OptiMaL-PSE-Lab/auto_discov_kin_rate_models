...
initial_conditions = {
    ...
    "ic_6": np.array([0.18940091, 0.91338518, 0.92559262]),
    "ic_7": np.array([0, 1.64124533, 1.09541306])
}
...
path = "Decomposition of Nitrous Oxide/Second Paper Data/hall_of_fame_rate_ADoK-W_3.csv"
...
def rate_model(z0, equations, t, t_eval, event):
    ...
    for equation in equations:
        ...
        equation = equation.replace("x3", "z[2]")
        equations[i] = equation
        i += 1

    def nest(t, z):
        dNOdt = (-1) * eval(str(equations[0]))
        dNdt = eval(str(equations[0]))
...
for i in range(num_exp):
    ...
    if i == 2:
        file_path = 'Decomposition of Nitrous Oxide/Experiment_3_Final_Model_DecomW.png'
