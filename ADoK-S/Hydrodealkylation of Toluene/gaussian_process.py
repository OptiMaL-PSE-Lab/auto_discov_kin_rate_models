...
for i in range(num_species):
    ...
    #     color = color_3[i], linestyle = '--', linewidth = 1)
ax.legend()
file_path = 'Hydrodealkylation of Toluene/Gaussian_process_prediction_test_noisy.png'
...
def SR_model(z0, equations, t, t_eval):
    ...
    for equation in equations:
        ...
        equation = equation.replace("M", "z[2]")
...
ax.grid(alpha = 0.5)
ax.legend()
file_path = 'Hydrodealkylation of Toluene/MBDoE_real_and_GP_model.png'
fig.savefig(file_path, dpi = 600)
