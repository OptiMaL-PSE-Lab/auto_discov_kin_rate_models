...
path = "Hydrodealkylation of Toluene/Second Paper Data/hall_of_fame_rate_ADoK-W.csv"
...
def rate_model(z0, equations, t, t_eval, event):
    ...
    for equation in equations:
        ...
        equation = equation.replace("x4", "z[3]")
        equations[i] = equation
        i += 1

    def nest(t, z):
        dTdt = (-1) * eval(str(equations[0]))
        dHdt = (-1) * eval(str(equations[0]))
        dBdt = eval(str(equations[0]))
        dMdt = eval(str(equations[0]))
        dzdt = [dTdt, dHdt, dBdt, dMdt]
        return dzdt
...
for i in range(num_exp):
    ...
    file_path = 'Hydrodealkylation of Toluene/Experiment_'+ str(i + 1) +'_Final_Model_HydroW.png'
