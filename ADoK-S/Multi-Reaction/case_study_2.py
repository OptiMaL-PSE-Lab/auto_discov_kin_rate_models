...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 15:32:27 2024
...
#             try:
#                 if j == 0:
#                     file_name = str("Multi-Reaction/data_2/hall_of_fame_A_" + str(i + 1) + ".csv")
#                 if j == 1:
#                     file_name = str("Multi-Reaction/data_2/hall_of_fame_B_" + str(i + 1) + ".csv")
#                 if j == 2:
#                     file_name = str("Multi-Reaction/data_2/hall_of_fame_C_" + str(i + 1) + ".csv")
...
#         try:
#             if i == 0:
#                 file_name = str("Multi-Reaction/data_2/hall_of_fame_rate_A"+ str(num_exp - 5) +".csv")
#                 Y = SR_derivatives_A
#                 num = 200 * 2
#             if i == 1:
#                 file_name = str("Multi-Reaction/data_2/hall_of_fame_rate_B"+ str(num_exp - 5) +".csv")
#                 Y = SR_derivatives_B
#                 num = 200 * 2
#             if i == 2:
#                 file_name = str("Multi-Reaction/data_2/hall_of_fame_rate_C"+ str(num_exp - 5) +".csv")
#                 Y = SR_derivatives_C
#                 num = 200 * 2
...
for i in range(num_species):
    if i == 0:
        path = "Multi-Reaction/data_2/hall_of_fame_rate_A"+ str(num_exp - 5) +".csv"
        name_models = "A_models"
        name_params = "A_params"
    
    if i == 1:
        path = "Multi-Reaction/data_2/hall_of_fame_rate_B"+ str(num_exp - 5) +".csv"
        name_models = "B_models"
        name_params = "B_params"
    
    if i == 2:
        path = "Multi-Reaction/data_2/hall_of_fame_rate_C"+ str(num_exp - 5) +".csv"
...
print(np.argpartition(AIC_values, 1)[0:10])
